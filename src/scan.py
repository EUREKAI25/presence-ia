...
_QUERIES: dict = {
    ...
    "plombier": [
        ...
        "Fuite d'eau qui appeler à {city} ?",
        "Plombier {city} avis fiable",
    ],
    "restaurant": [
        "Meilleur restaurant à {city} ?",
        "Restaurant recommandé {city}",
        "Où manger à {city} ce soir ?",
        "Restaurant gastronomique {city}",
        "Meilleure table {city} avis",
    ],
    "default": [
